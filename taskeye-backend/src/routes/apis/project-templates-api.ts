...
projectTemplatesApiRouter.get("/taskeye-templates", safeControllerFunction(ProjectTemplatesController.getTemplates));
projectTemplatesApiRouter.get("/taskeye-templates/:id", safeControllerFunction(ProjectTemplatesController.getTemplateById));

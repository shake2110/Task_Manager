...
export default abstract class TaskEyeControllerBase {
  ...
  protected static isValidHost(hostname: string) {
    return hostname === "taskeye.com"
      || hostname === "www.taskeye.com"
      || hostname === "dev.taskeye.com"
      || hostname === "uat.taskeye.com";
  }

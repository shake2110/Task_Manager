...
import {TASK_PRIORITY_COLOR_ALPHA, TaskEyeColorCodes, TaskEyeColorShades} from "../shared/constants";

export default class LabelsController extends TaskEyeControllerBase {
  @HandleExceptions()
  ...
  public static async updateColor(req: IWorkLenzRequest, res: IWorkLenzResponse): Promise<IWorkLenzResponse> {
    ...
    if (!Object.values(TaskEyeColorShades).flat().includes(req.body.color))

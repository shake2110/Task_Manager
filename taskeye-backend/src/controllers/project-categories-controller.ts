...
import { TaskEyeColorShades } from "../shared/constants";
import { SqlHelper } from "../shared/sql-helpers";

export default class ProjectCategoriesController extends TaskEyeControllerBase {
  ...
  public static async create(
    ...
    if (req.body.color_code) {
      ...
      const validColors = [
        ...Object.keys(TaskEyeColorShades),
        ...Object.values(TaskEyeColorShades).flat(),
      ].map((c) => c.toLowerCase());

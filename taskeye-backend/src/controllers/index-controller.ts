...
export default class IndexController extends TaskEyeControllerBase {
  ...
  public static auth(req: IWorkLenzRequest, res: IWorkLenzResponse) {
    if (req.isAuthenticated())
      return res.redirect("/taskeye");
    return res.render("admin");
  }

  public static taskeye(req: IWorkLenzRequest, res: IWorkLenzResponse) {
    if (req.isAuthenticated())
      return res.render("admin");

...
export default class BillingController extends TaskEyeControllerBase {
...
VALUES ($1, $2, $3);`;
  ...
  public static async getDirectPayObject(req: IWorkLenzRequest, res: IWorkLenzResponse): Promise<IWorkLenzResponse> {
    ...
    const payload = {
      ...
      page_type: "IN_APP",
      logo: "https://app.taskeye.com/assets/icons/icon-96x96.png",
  ...
  public static async contactUs(req: IWorkLenzRequest, res: IWorkLenzResponse): Promise<IWorkLenzResponse> {
    ...
    const html = `<!DOCTYPE html>
      ...
      <head>
          ...
          <title>TaskEye Local Billing - Contact Information</title>
      </head>
      <body>
          <div>
              <h1 style="text-align: center; margin-bottom: 20px;">TaskEye Local Billing - Contact Information</h1>
    ...
    sendEmail({
      to,
      subject: "TaskEye - Local billing contact.",
      html
    });

...
import { AvatarNamesMap, NumbersColorMap, TaskEyeColorCodes } from "./constants";
...
export function isTestServer() {
  ...
  return hostname === "dev.taskeye.com" || hostname === "uat.app.taskeye.com";
}
...
export function getRandomColorCode() {
  ...
  return TaskEyeColorCodes[~~(Math.random() * TaskEyeColorCodes.length)];
}

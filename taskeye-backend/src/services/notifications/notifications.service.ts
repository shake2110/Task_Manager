...
import TaskEyeNotification from "./notification";
...
export class NotificationsService {
  ...
  public static sendNotification(receiver: IReceiver): void {
    const url = receiver.project_id ? `/taskeye/projects/${receiver.project_id}` : null;
    const notification = new TaskEyeNotification(receiver.team, receiver.team_id, receiver.message, url);

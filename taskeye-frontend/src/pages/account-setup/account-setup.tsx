...
} from '@/shared/taskeye-analytics-events';
...
import logo from '@/assets/images/taskeye-light-mode.png';
import logoDark from '@/assets/images/taskeye-dark-mode.png';

...
const TaskEyeColorCodes = Object.values(TaskEyeColorShades).flat();
...
const LabelsDrawer = ({
  ...
  useEffect(() => {
    if (labelId) {
      ...
      form.resetFields();
      form.setFieldsValue({ color_code: Object.keys(TaskEyeColorShades)[0] }); // Set default color
    }
  }, [labelId, form]);
    ...
    >
      <div
        style={{
          width: 40,
          height: 40,
          backgroundColor: value || Object.keys(TaskEyeColorShades)[0],
          borderRadius: 4,
          border: `1px solid ${token.colorBorder}`,
          cursor: 'pointer',
          transition: 'all 0.2s ease',

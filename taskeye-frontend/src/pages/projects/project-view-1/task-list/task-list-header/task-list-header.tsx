...
// import TaskEyeTaskListPhaseDuration from "./TaskEyeTaskListPhaseDuration";
// import TaskEyeTasksProgressBar from "./TaskEyeTasksProgressBar";
    ...
    <div className="d-flex justify-content-between align-items-center position-relative">
      ...
      {/* {isGroupByPhases && group.name !== "Unmapped" && (
        <div className="d-flex align-items-center me-2 ms-auto">
          <TaskEyeTaskListPhaseDuration group={group} />
        </div>
      )}

      {isProgressBarAvailable() && (
        <TaskEyeTasksProgressBar

      ...
      >
        {hasCompletedSurvey ? (
          <Result
            ...
            subTitle="Thank you for completing the personalization survey. Your responses help us improve TaskEye."
            extra={
          ...
          <>
            <Alert
              ...
              description="Take a quick survey to tell us about your organization and how you use TaskEye."
              type="info"
              showIcon

...
import { evt_projects_create } from '@/shared/taskeye-analytics-events';
    ...
    try {
      ...
      if (response?.data?.done) {
        ...
        if (!editMode) {
          ...
          navigate(
            `/taskeye/projects/${response.data.body.id}?tab=tasks-list&pinned_tab=tasks-list`
          );
        }
        refetchProjects();

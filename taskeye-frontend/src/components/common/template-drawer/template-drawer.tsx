...
interface TemplateDrawerProps {
  ...
  selectedTemplateType: (type: 'taskeye' | 'custom') => void;
}
...
const TemplateDrawer: React.FC<TemplateDrawerProps> = ({
  ...
  selectedTemplateType = (type: 'taskeye' | 'custom') => {
  },
}) => {
  ...
  const [templates, setTemplates] = useState<ITaskEyeTemplate[]>([]);
  ...
  const getTemplates = async () => {
    try {
      ...
      const res = await projectTemplatesApiService.getTaskEyeTemplates();
      if (res.done) {

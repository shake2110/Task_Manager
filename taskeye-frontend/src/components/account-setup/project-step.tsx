...
import { IAccountSetupRequest, ITaskEyeTemplate, IProjectTemplate } from '@/types/project-templates/project-templates.types';

import { evt_account_setup_template_complete } from '@/shared/taskeye-analytics-events';
...
export const ProjectStep: React.FC<Props> = ({ onEnter, styles, isDarkMode = false, token }) => {
  ...
  const fetchTemplates = async () => {
    try {
      ...
      const templatesResponse = await projectTemplatesApiService.getTaskEyeTemplates();
  ...
  const createFromTemplate = async () => {
    ...
    try {
      ...
      if (res.done && res.body.id) {
        ...
        navigate(`/taskeye/projects/${res.body.id}?tab=tasks-list&pinned_tab=tasks-list`);
      }
    } catch (error) {

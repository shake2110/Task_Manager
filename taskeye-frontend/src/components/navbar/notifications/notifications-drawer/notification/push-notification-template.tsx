...
const PushNotificationTemplate = ({
  ...
  notification: ITaskEyeNotification;
}) => {
...
let notificationQueue: ITaskEyeNotification[] = [];
...
export const showNotification = (notificationData: ITaskEyeNotification) => {

      ...
      label: (
        ...
        >
          {isOwnerOrAdmin && !isLicenseExpired && (
            <Link to="/taskeye/admin-center/overview" style={getLinkStyle()}>
              {t('adminCenter')}
            </Link>
          )}
          {!isLicenseExpired && (
            <Link to="/taskeye/settings/profile" style={getLinkStyle()}>
              {t('settings')}
            </Link>
          )}
          {isLicenseExpired && (
            <Link to="/taskeye/settings/account-deletion" style={getDangerLinkStyle()}>
              {t('deleteAccount')}
            </Link>
          )}
